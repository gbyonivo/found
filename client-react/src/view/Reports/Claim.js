...
const Claim = ({ claim: { createdAt, status, description, id }, showButtons, busy, answer }) => {
  ...
  return <div className="bg-gray-100 mb-4 p-4 rounded bg-gray-100">
    ...
    {
      showButtons && status === statusses.PENDING.value && <div className="flex justify-end">
